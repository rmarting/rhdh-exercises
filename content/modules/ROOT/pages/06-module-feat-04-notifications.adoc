...
* https://docs.redhat.com/en/documentation/red_hat_developer_hub/1.9/html-single/customizing_red_hat_developer_hub/index#enable-software-template-version-update-notifications-in-rhdh_about-software-templates[Enabling Software Template version update notifications in Red Hat Developer Hub]
