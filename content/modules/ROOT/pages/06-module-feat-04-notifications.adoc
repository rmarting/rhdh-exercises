...
If we change the version of the template used, a https://docs.redhat.com/en/documentation/red_hat_developer_hub/{rhdh_version}/html-single/customizing_red_hat_developer_hub/index#enable-software-template-version-update-notifications-in-rhdh_about-software-templates[notification^]
