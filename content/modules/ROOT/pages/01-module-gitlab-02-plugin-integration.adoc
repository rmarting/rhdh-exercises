...
More information about Dynamic Plugins https://docs.redhat.com/en/documentation/red_hat_developer_hub/{rhdh_version}/html-single/installing_and_viewing_plugins_in_red_hat_developer_hub/index[here^].
...
- GitLab UI navigation: menu:Profile[Access > Personal Access Tokens > Add new token]
