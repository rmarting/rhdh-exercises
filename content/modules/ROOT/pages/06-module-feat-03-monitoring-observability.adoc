...
measure it? Easy! There are a set of plugins to https://docs.redhat.com/en/documentation/red_hat_developer_hub/{rhdh_version}/html-single/monitoring_and_logging/index#proc-admin-enabling-metrics-ocp-operator_assembly-rhdh-observability[monitor the behavior^]
of the users of Red Hat Developer Hub. Using the https://docs.redhat.com/en/documentation/red_hat_developer_hub/{rhdh_version}/html-single/adoption_insights_in_red_hat_developer_hub/index#con-about-adoption-insights_title-adoption-insights[Adoption Insights^] plugin,
