...
[source,bash,subs="+macros,+attributes"]
----
oc apply -f ./ls-llama-stack-secrets.yaml -n rhdh-gitlab
----
...
- https://docs.redhat.com/en/documentation/red_hat_developer_hub/1.9/html-single/interacting_with_red_hat_developer_lightspeed_for_red_hat_developer_hub/index[Interacting with Red Hat Developer Lightspeed for Red Hat Developer Hub]
- https://docs.redhat.com/en/documentation/red_hat_developer_hub/1.9/html-single/interacting_with_red_hat_developer_lightspeed_for_red_hat_developer_hub/index#con-about-developer-lightspeed_developer-lightspeed[About Developer Lightspeed]
