...
* Install cert-manager, GitLab, and Red Hat Developer Hub operators
* Deploy GitLab and run initial group/user/repository setup
* Deploy a base Backstage CR and verify the Red Hat Developer Hub route

== Login OpenShift

. Using the admin credentials, login to the OpenShift console:
+
[.console-input]
[source,bash,subs="+macros,+attributes"]
----
oc login -u admin 
oc login --token=sha256~p5UOTmRrdoLBiMmdIiFyWgiCL8XL7UIPC8qcsSsCAnk --server=https://api.cluster-8pn7c.dynamic2.redhatworkshops.io:6443
----
