...
* https://docs.redhat.com/en/documentation/red_hat_developer_hub/1.9/html-single/configuring_red_hat_developer_hub/index#use-the-dynamic-plugins-cache_configuring-rhdh[Enabling the dynamic plugins cache]
